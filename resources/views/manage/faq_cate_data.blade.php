<!-- 檔案位置: resources/views/manage/faq_cate_data.blade.php -->
  {{-- 設定變數 --}}
  <?php 
  //$title = '最新消息'; 
  $IsFirstPage = FALSE;
  ...
  $SysPath = "/manage/";
  $cFile = "faq_cate_data";
  $cFile_Add = "faq_cate_add";
  $cFile_Del = "faq_cate_del";
  $cFile_Edit = "faq_cate_edit";
  $cFile_Save = "faq_cate_save";
  $cFile_List = "faq_cate_list";
