<!-- 檔案位置: resources/views/manage/news_cate_data.blade.php -->
  {{-- 設定變數 --}}
  <?php 
  //$title = '最新消息'; 
  $IsFirstPage = FALSE;
  ...
  //------------------------------//
  $SysPath = "/manage/";
  $cFile = "news_cate_data";
  $cFile_Add = "news_cate_add";
  $cFile_Del = "news_cate_del";
  $cFile_Edit = "news_cate_edit";
  $cFile_Save = "news_cate_save";
  $cFile_List = "news_cate_list";
