<!-- 檔案位置: resources/views/manage/partner_cate_data.blade.php -->
  {{-- 設定變數 --}}
  <?php 
  //$title = '最新消息'; 
  $IsFirstPage = FALSE;
  $subnav = "partner";
  $subnav2 = "partner_cate";
  //------------------------------//
  $SysPath = "/manage/";
  $cFile = "partner_cate_data";
  $cFile_Add = "partner_cate_add";
  $cFile_Del = "partner_cate_del";
  $cFile_Edit = "partner_cate_edit";
  $cFile_Save = "partner_cate_save";
  $cFile_List = "partner_cate_list";
