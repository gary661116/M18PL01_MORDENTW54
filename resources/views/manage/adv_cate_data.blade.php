<!-- 檔案位置: resources/views/manage/advertisement_cate_data.blade.php -->
  {{-- 設定變數 --}}
  <?php 
  //$title = '最新消息'; 
  $IsFirstPage = FALSE;
  ...
  $SysPath = "/manage/";
  $cFile = "adv_cate_data";
  $cFile_Add = "adv_cate_add";
  $cFile_Del = "adv_cate_del";
  $cFile_Edit = "adv_cate_edit";
  $cFile_Save = "adv_cate_save";
  $cFile_List = "adv_cate_list";
