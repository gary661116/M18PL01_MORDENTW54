<!-- 檔案位置: resources/views/manage/project_cate_data.blade.php -->
  {{-- 設定變數 --}}
  <?php 
  //$title = '最新消息'; 
  $IsFirstPage = FALSE;
  $subnav = "project";
  $subnav2 = "project_cate";
  //------------------------------//
  $SysPath = "/manage/";
  $cFile = "project_cate_data";
  $cFile_Add = "project_cate_add";
  $cFile_Del = "project_cate_del";
  $cFile_Edit = "project_cate_edit";
  $cFile_Save = "project_cate_save";
  $cFile_List = "project_cate_list";
