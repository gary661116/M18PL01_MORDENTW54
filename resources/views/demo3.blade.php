    ...
    <body>
        ...
        <script>
             function chg_url(){
                ...
                curlA = "https://www.facebook.com/plugins/video.php?href=" + c_url + "&width=300&show_text=false&height=300&appId"
                $('#f_url2').html(c_url);
...
<!--</form>-->
   <dl class="field">
    ...
    --}}
    <dl class="field">
        <dt class="col-1">直播</dt>
        <dd class="col-6">
            <iframe id="ifrmA" name="ifrmA" src="https://www.facebook.com/plugins/video.php?href={{ $fb_urla }}&width=300&show_text=false&height=300&appId" width="300" height="300" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media" allowFullScreen="false"></iframe>
        </dd>
    </dl>      
