<?php
   ...
   class Faq{
       //類別屬性
       //------------------------------------------------------------------------------------------------------------------//
       private $cate_dbf_name = "faq_cate";
       private $dbf_name = "faq";
       private $img_kind = "faq";
       //-----------------------------------------------------------------------------------------------------------------//
       //類別
       //-----------------------------------------------------------------------------------------------------------------//
       //呈現
       ...
       //-----------------------------------------------------------------------------------------------------------------//
       //資料呈現
       public function clist($id = "", $sort = "", $status = "", $title_query = "", $start_date = "", $end_date = "", $is_index = "", $cate_id = ""){
            $csql = "";
            $input_chk = "";
       ...
       //新增
       public function cinsert($c_title = "", $c_url = "", $c_date = "", $c_desc = "", $show = "", $is_index = "", $sort = "", $c_memo = "", $cate_id = "", $img_no = "", $bd_id = "System"){
           if($sort == ""){
               $sort = "0";
           }

           $csql = "insert into " . $this->dbf_name . "(cate_id, c_title, c_date, c_url, c_desc, c_memo, is_index, sort, status, bd_id, bd_dt) "
                 . "values(:cate_id, :c_title, :c_date, :c_url, :c_desc, :c_memo, :is_index, :sort, :show, :bd_id, now())";
       ...
       //更新
       public function cupdate($id = "", $c_title = "", $c_url = "", $c_desc = "", $c_date = "", $c_memo = "", $show = "", $is_index = "", $sort = "", $cate_id = "", $upd_id = "System"){
             $csql = "update " 
                   . "  " . $this->dbf_name . " " 
                   . "set "
                   . "  c_title = :c_title "
