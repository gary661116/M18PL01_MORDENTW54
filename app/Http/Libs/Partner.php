<?php
   //檔案位置 app/Http/Libs/Partner.php
   ...
   class Partner{
       //類別屬性
       //------------------------------------------------------------------------------------------------------------------//
       private $cate_dbf_name = "partner_cate";
       private $dbf_name = "partner";
       private $img_kind = "partner";
       //-----------------------------------------------------------------------------------------------------------------//
       //類別
       //-----------------------------------------------------------------------------------------------------------------//
       //呈現
       ...
       //新增
       public function cinsert($c_title = "", $c_url = "", $c_desc = "", $show = "", $sort = "", $cate_id = "", $img_no = "", $bd_id = "System"){
           if($sort == ""){
               $sort = "0";
           }

           $csql = "insert into " . $this->dbf_name . "(cate_id, c_title, c_url, c_desc, sort, status, bd_id, bd_dt) "
                 . "values(:cate_id, :c_title, :c_url, :c_desc, :sort, :show, :bd_id, now())";
       ...
       //更新
       public function cupdate($id = "", $c_title = "", $c_url = "", $c_desc = "", $show = "", $sort = "", $cate_id = "", $upd_id = "System"){
             $csql = "update " 
                   . "  " . $this->dbf_name . " " 
                   . "set "
                   . "  c_title = :c_title "
